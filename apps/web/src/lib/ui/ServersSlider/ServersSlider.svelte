...
>
	<button
		class="h-13 w-13 bg-main-900 text-main-500 aspect-square hocus:bg-main-800 hocus:text-main-200 hover:cursor-pointer transition-colors duration-75 flex items-center justify-center rounded-md"
