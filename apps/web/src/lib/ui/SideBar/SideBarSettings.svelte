...
<aside
	class="bg-main-950 h-full border-r-[0.5px] border-r-main-700 w-[15rem] overflow-hidden p-2 shrink-0"
>
	<Dialog.Close
		type="button"
	...
	<section class="flex flex-col h-full gap-y-1">
		{#each settings as setting, idx (idx)}
			<button
				class={[
					'text-left px-2.5 py-1.5 transition-colors duration-75 hover:cursor-pointer',
					activeSection === setting
						? 'text-main-50 bg-main-800/60'
						: 'text-main-300 hocus:bg-main-800/80 hocus:text-main-200'
				]}
