				...
				{#if open}
					...
					>
						<div class="relative w-full py-5 px-4">
							...
							<Dialog.Close
								type="button"
								class="text-main-400 h-8 w-8 hover:bg-main-900 hover:text-main-50 absolute top-3 right-3 transition-colors hover:cursor-pointer border-[0.5px] border-main-700 aspect-square flex justify-center items-center duration-75 rounded-sm"
							>
						...
						<div class="flex justify-end p-3">
							<button
								...
								class="bg-red-400/20 border-[0.5px] border-red-400 px-2 py-1 hover:cursor-pointer hover:bg-red-400 transition-colors duration-75 text-red-400 hover:text-red-50 rounded-sm"
							>
