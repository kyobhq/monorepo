...
<div
	class={[
		'pointer-events-auto bg-main-900 border-[0.5px] border-main-800 placeholder:text-main-400 hover:bg-main-800 hover:border-main-600 transition-colors duration-100 focus:ring-0 [&>.tiptap]:px-3 [&>.tiptap]:py-2 [&>.tiptap]:min-h-[5rem] rounded-sm',
		classes
	]}
	bind:this={element}
></div>
